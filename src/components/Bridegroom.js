      ...
      >
          ...
          <div className="w-50 d-flex align-items-center">
            <div className="info valign m-0 p-3">
              <div className="full-width">
                <h4 className="text-center fs-2 mb-0">Đỗ Hữu Phát</h4>{" "}
                ...
                <p>
                  ...
                  <p>***----------***</p>* The best thing to hold onto in life
                  is each other.
                  <p>
        ...
        <div className="d-flex">
          <div className="w-50 d-flex align-items-center">
            <div className="info valign m-0 p-3">
              <div className="full-width">
                <h4 className="text-center fs-2 mb-0">Chu Thị Linh Phương</h4>{" "}
                <span className="d-flex justify-content-center">
                  08/03/1998
                </span>
                <p>
                  ...
                  <p>***----------***</p>* To the world you may be one person,
